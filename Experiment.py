...
def average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length, learning_rate, gamma, policy='egreedy', 
    ...
    print(np.array(returns_over_repetitions).shape)
...
def experiment():
    ...
    optimal_episode_return = 84 # set the optimal return per episode you found in the DP assignment here - it was 100
    '''
